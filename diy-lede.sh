...
sed -i 's/OpenWrt/OpenWrt-5520/g' ./package/base-files/files/bin/config_generate
...
svn co https://github.com/user1121114685/koolproxyR/ package/lean/luci-app-koolproxyR
svn co https://github.com/user1121114685/koolproxyR/ package/lean/koolproxyR
git clone  https://github.com/user1121114685/koolproxyR.git package/lean/koolproxyR
